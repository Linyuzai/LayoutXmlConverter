...
public class ViewAttrValue {
    public static final String EMPTY = "";

    public static final String MATCH_PARENT = "matchParent";
    public static final String WRAP_CONTENT = "wrapContent";

    public static final String ORIENTATION_VERTICAL = "LinearLayout.VERTICAL";
    public static final String ORIENTATION_HORIZONTAL = "LinearLayout.HORIZONTAL";
    ...
    public static final String GRAVITY_RIGHT = "Gravity.RIGHT";
    public static final String GRAVITY_FILL = "Gravity.FILL";
    public static final String GRAVITY_FILL_VERTICAL = "Gravity.FILL_VERTICAL";
    public static final String GRAVITY_FILL_HORIZONTAL = "Gravity.FILL_HORIZONTAL";
    public static final String GRAVITY_CLIP_VERTICAL = "Gravity.CLIP_VERTICAL";
    public static final String GRAVITY_CLIP_HORIZONTAL = "Gravity.CLIP_HORIZONTAL";

    public static final String SCALE_TYPE_CENTER = "ImageView.ScaleType.CENTER";
    public static final String SCALE_TYPE_CENTER_CROP = "ImageView.ScaleType.CENTER_CROP";
    public static final String SCALE_TYPE_CENTER_INSIDE = "ImageView.ScaleType.CENTER_INSIDE";
    public static final String SCALE_TYPE_FIT_CENTER = "ImageView.ScaleType.FIT_CENTER";
    public static final String SCALE_TYPE_FIT_START = "ImageView.ScaleType.FIT_START";
