...
public class XmlAttrName {
    ...
    public static final String LAYOUT_PADDING = "android:padding";
    public static final String LAYOUT_PADDING_TOP = "android:paddingTop";
    public static final String LAYOUT_PADDING_RIGHT = "android:paddingRight";
    public static final String LAYOUT_PADDING_BOTTOM = "android:paddingBottom";
    public static final String LAYOUT_PADDING_LEFT = "android:paddingLeft";
    public static final String LAYOUT_PADDING_START = "android:paddingStart";
    public static final String LAYOUT_PADDING_END = "android:paddingEnd";
    public static final String LAYOUT_PADDING_VERTICAL = "android:paddingVertical";
    public static final String LAYOUT_PADDING_HORIZONTAL = "android:paddingHorizontal";
